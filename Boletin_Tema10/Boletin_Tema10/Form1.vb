Public Class Form1
    Private Sub btn1_Click(sender As Object, e As EventArgs) Handles btnEjercicio1.Click
        Me.Hide()
    ...
    Private Sub btnEjercicio6_Click(sender As Object, e As EventArgs) Handles btnEjercicio6.Click
        Me.Hide()
        Ejercicio6.ShowDialog()
    End Sub

    Private Sub btnEjercicio7_Click(sender As Object, e As EventArgs) Handles btnEjercicio7.Click
        Me.Hide()
        Ejercicio7.ShowDialog()
    End Sub

    Private Sub btnEjercicio8_Click(sender As Object, e As EventArgs) Handles btnEjercicio8.Click
        Me.Hide()
        Ejercicio8.ShowDialog()
    End Sub

    Private Sub btnEjercicio9_Click(sender As Object, e As EventArgs) Handles btnEjercicio9.Click
        Me.Hide()
        Ejercicio9.ShowDialog()
    End Sub

    Private Sub btnEjercicio10_Click(sender As Object, e As EventArgs) Handles btnEjercicio10.Click
        Me.Hide()
